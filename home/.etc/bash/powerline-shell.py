...
# NOTE: Generated by home/.etc/vendor/powerline-shell/install.py
# To update, edit home/.etc/vendor/powerline-shell/config.py
# then run home/.etc/vendor/powerline-shell/install.py
